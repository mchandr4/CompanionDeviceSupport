...
import com.google.android.connecteddevice.service.AssociatedDeviceViewModel.AssociationState;
...
public final class AssociatedDeviceViewModelTest {
  ...
  @Test
  public void startAssociation_starting() throws RemoteException {
    viewModel.startAssociation();
    viewModel.getAssociationState().observeForever(mockAssociationStateObserver);
    waitForLiveDataUpdate();
  ...
  @Test
  public void startAssociation_started() throws RemoteException {
    viewModel.startAssociation();
